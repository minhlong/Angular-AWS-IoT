...
Username: hominhlong.it@gmail.com; Password: 23456789
...
Mình đang làm dự án về `IoT (Internet of ThingS)`, công ty hiện đã làm xong thiết bị và bây giờ họ muốn xây dựng một hệ thống để quản-lý/sử-dụng thiết bị đó. Nhưng nếu phải xây dựng từ đầu thì mất rất nhiều chi phí... Nào là máy chủ, lập trình viên, chi phí bảo trì ... Và có một giải pháp lúc này sử dụng `Amazon Web Services (AWS)`
...
> - `Code`: Bạn có thể biến môi trường... để function của bạn xử lý. Ngoài ra, bạn còn có thể connect đến các dịch vụ khác nữa (Coding mà) như `DynamoDB`, `SNS`...
